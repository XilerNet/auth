...
const CALLBACK_URL = isDevelopment ? 'http://localhost:8001/#/auth' : 'https://private-alpha-3hVEH2UeFZUQEPP9.xiler.net/#/auth';
...
const fetchXiler = async (url: string, method: string, body: Object) => {
  try {
    ...
    console.error(e);
    if (window.confirm("Failed to connect to Xiler, retry?")) {
